...
mkdir -p $HOME/style_simple/Song 
mv Access-Granted.mp3 Jarvis2.mp3 JARVIS.mp3 sound_effect.py $HOME/style_simple/Song
rm 1
mkdir -p $HOME/style_simple/NETWORK
mv network.py $HOME/style_simple/NETWORK
